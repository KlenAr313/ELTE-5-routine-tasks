...
void CMyApp::RenderGUI()
{
	...
	if (ImGui::Begin("Filter control"))
	{
		...
		static int k = 5;
		if (ImGui::SliderInt("k", &k, 0, 20))
			glProgramUniform1i(m_programPostprocessID, ul(m_programPostprocessID, "k"), k);
		ImGui::End();
	}
}
...
void CMyApp::Resize(int _w, int _h)
{
	...
	glProgramUniform2f(m_programPostprocessID,ul(m_programPostprocessID, "res"),
