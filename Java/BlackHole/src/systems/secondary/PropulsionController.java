...
public class PropulsionController implements Runnable {
    ...
    public PropulsionController(String name, PowerSupplier supplier, SpacecraftData spacecraftData)
    {
        ...
        while (!Thread.currentThread().isInterrupted() && checking)
        {
            try {
                ...
                if(secondarySystemState != SecondarySystemState.CRITICAL)
                {
                    ...
                    if (res)
                    {
                        System.out.println("[" + name + "]: PropulsionController is running, consuming " + powerNeeded + " units of power.");
                    ...
                    } else
                    {
                        ...
                        } else
                        {
                            if (secondarySystemState == SecondarySystemState.HEALTHY)
                            {
                                ...
                                System.out.println("[" + name + "]: Not enough power for PropulsionController. Switching off...");
                ...
                {
                    System.out.println("[" + name + "]: the crew has died (A malfunction occurred in the PropulsionController.)!");
