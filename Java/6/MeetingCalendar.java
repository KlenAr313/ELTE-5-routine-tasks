...
public class MeetingCalendar {
    ...
    private static Map<Date, String> meetings = java.util.Collections.synchronizedMap(new HashMap<Date, String>());
    //private static Map<Date, String> meetings = new java.util.concurrent.ConcurrentHashMap<Date, String>();
